...
if (isset($_POST['change'])) {
    ...
    $chngpwd1->execute();
    $msg = "รหัสผ่านของคุณเปลี่ยนสำเร็จแล้ว";
}
        ...
        <aside id="slide-out" class="side-nav white fixed">
            <div class="side-nav-wrapper">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="material-icons">account_box</i>การกู้คืนรหัสผ่าน</a></li>
                </ul>
            </div>
        </aside>
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">
                        <h4>การกู้คืนรหัสผ่านของพนักงาน</h4>
                    </div>
                    ...
                    <div class="col s12 m6 l8 offset-l2 offset-m3">
                        <div class="card white darken-1">
                            ...
                            <div class="card-content ">
                                <span class="card-title" style="font-size:20px;">รายละเอียดพนักงาน</span>
                                ...
                                <div class="row">
                                    <form class="col s12" name="signin" method="post">
                                        ...
                                        <div class="input-field col s12">
                                            ...
                                            <label for="password">อีเมล์</label>
                                        </div>
                            ...
                            ?>
                                    ...
                                    <div class="row">
                                        <span class="card-title" style="font-size:20px;">เปลี่ยนรหัสผ่านของคุณ</span>
                                        <form class="col s12" name="udatepwd" method="post">
                                            ...
                                            <div class="input-field col s12">
                                                <button type="submit" name="change" class="waves-effect waves-light btn indigo m-b-xs" onclick="return valid();">บันทึก</button>
                                ...
                                <?php } else { ?>
                                    <div class="errorWrap" style="margin-left: 2%; font-size:22px;">
                                        <strong>ข้อผิดพลาด</strong> : <?php echo htmlentities("รายละเอียดไม่ถูกต้อง");
                                                                    } ?>
                                    </div>
                                <?php } ?>
