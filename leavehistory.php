                            ...
                            <table id="example" class="display responsive-table ">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="200">หมายเหตุของเเอดมิน</th>
                                        <th>สถานะ</th>
                                    </tr>
                                </thead>
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) {               ?>
                                            <tr>
                                                ...
                                                <td><?php echo date('d/m/Y',strtotime("+543 years",strtotime(($result->ToDate)))) ;  ?></td>
                                                <td><?php echo date('d/m/Y',strtotime("+543 years",strtotime(($result->FromDate)))); ?></td>
