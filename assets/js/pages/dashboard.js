$(document).ready(function () {
  setTimeout(function () {
    Materialize.toast("ยินดีต้อนรับสู่ระบบการลาออนไลน์", 4000);
  }, 2000);
  ...
  var DrawSparkline = function () {
    var linePoints = [
      0, 1, 3, 2, 1, 1, 4, 1, 2, 0, 3, 1, 3, 4, 1, 0, 2, 3, 6, 3, 4, 2, 7, 5, 2,
      4, 1, 2, 6, 13, 4, 2,
    ];
    ...
    $("#sparkline-bar").sparkline(barPoints, {
      ...
      barWidth: barWidth,
      barSpacing:
        (barParent.width() - barPoints.length * barWidth) / barPoints.length,
      barColor: "rgba(0,0,0,.07)",
      tooltipFormat:
        ' <span style="color: #ccc">&#9679;</span> {{value}}</span>',
    });
  };
