        ...
        <div class="middle-content">
            <div class="row no-m-t no-m-b">
                ...
                <div class="col s12 m12 l4">
                    <div class="card stats-card">
                        <div class="card-content">
                            ...
                            <span class="card-title">จำนวนแผนกทั้งหมด</span>
                            <?php
                ...
                <div class="col s12 m12 l4">
                    <div class="card stats-card">
                        <div class="card-content">
                            <span class="card-title">จำนวนผู้รออนุมัติการ</span>
                            <?php
                ...
                <div class="col s12 m12 l12">
                    <div class="card invoices-card">
                        <div class="card-content">
                            ...
                            <span class="card-title">การลาล่าสุด</span>
                            <table id="example" class="display responsive-table ">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="180">วันที่โพลต์</th>
                                        <th>สถานะ</th>
                                        <th align="center">การกระทำ</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="leave-details.php?leaveid=<?php echo htmlentities($result->lid); ?>"
                                                class="waves-effect waves-light btn blue m-b-xs">ดูรายละเอียด</a></td>
                                    </tr>
                                    <?php $cnt++;
                                            }
                                        } ?>
