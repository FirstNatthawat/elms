...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['add'])) {
        ...
        if ($lastInsertId) {
            $msg = "เพิ่มประเภทการลาเรียบร้อยแล้ว";
        } else {
                            ...
                            <div class="row">
                                <form class="col s12" name="chngpwd" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12">
                                            <button type="submit" name="add" class="waves-effect waves-light btn indigo m-b-xs">บันทึก</button>
