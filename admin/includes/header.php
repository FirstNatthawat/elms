                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">
                            <span class="chapter-title">แอดมิน</span>
                        </div>
                        ...
                        <ul id="dropdown1" class="dropdown-content notifications-dropdown">
                            <li class="notificatoins-dropdown-container">
                                <ul>
                                    <li class="notification-drop-title">แจ้งเตือน</li>
                                    <?php
                                    $isread = 0;
                                                ...
                                                <a href="leave-details.php?leaveid=<?php echo htmlentities($result->lid); ?>">
                                                    <div class="notification">
                                                        ...
                                                        <div class="notification-text">
                                                            <p><b><?php echo htmlentities($result->FirstName . " " . $result->LastName); ?><br />(<?php echo htmlentities($result->EmpId); ?>)</b> ลา</p><span>เมื่อ <?php echo htmlentities($result->PostingDate); ?></b< /span>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
