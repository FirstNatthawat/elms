...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['add'])) {
        ...
        $sql = "INSERT INTO tblemployees (EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Type_Employee,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:Type_Employee,:status)";
                                    ...
                                    <section>
                                        <div class="wizard-content">
                                            <div class="row">
                                                <div class="col m6">
                                                    <div class="row">
                                                        <?php if ($error) { ?><div class="errorWrap"><strong>ข้อผิดพลาด</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div class="succWrap"><strong>สำเร็จ</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
                                                ...
                                                <div class="col m6">
                                                    <div class="row">
                                                        <div class="input-field col m6 s12">
                                                            <select name="gender" id="gender" autocomplete="off" required="" aria-required="true">
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            <select name="department" autocomplete="off" required="" aria-required="true">
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            <select name="Type_Employee" id="Type_Employee" autocomplete="off" required="" aria-required="true">
                                                        ...
                                                        <div class="input-field col s12">
                                                            <button type="submit" name="add" onclick="return valid();" id="add" class="waves-effect waves-light btn indigo m-b-xs">บันทึก</button>
