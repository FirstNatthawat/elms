...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "update tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno,Type_Employee=:Type_Employee where id=:eid";
                                    ...
                                    <section>
                                        <div class="wizard-content">
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            <select name="Type_Employee" id="Type_Employee" autocomplete="off" required="" aria-required="true">
                                                                <option value="<?php echo htmlentities($result->Type_Employee); ?>"><?php echo htmlentities($result->Type_Employee); ?></option>
                                                ...
                                                <div class="input-field col s12">
                                                    <button type="submit" name="update" id="update" class="waves-effect waves-light btn indigo m-b-xs">อัปเดต</button>
