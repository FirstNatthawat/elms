...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $msg = "อัปเดตประเภทการลาเรียบร้อยแล้ว";
    }
...
?>
    ...
    <body>
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">แก้ไขประเภทการลา</div>
                </div>
                            ...
                            <div class="row">
                                <form class="col s12" name="chngpwd" method="post">
                                    ...
                                    if ($query->rowCount() > 0) {
                                        ...
                                        <div class="input-field col s12">
                                            <button type="submit" name="update" class="waves-effect waves-light btn indigo m-b-xs">อัปเดต</button>
