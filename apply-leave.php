...
if (strlen($_SESSION['emplogin']) == 0) {
    ...
    if (isset($_POST['apply'])) {
        ...
        $imageName = $_FILES['leave_picture']['name'];
        $tempPath = $_FILES["leave_picture"]["tmp_name"];
            ...
            <div class="col s12 m12 l8">
                <div class="card">
                    <div class="card-content">
                        <form id="example-form" method="post" name="addleave" enctype="multipart/form-data">
                            <div>
                                <h3>ลางาน</h3>
                                <section>
                                    <div class="wizard-content">
                                        <div class="row">
                                            <div class="col m12">
                                                <div class="row">
                                                    <?php if ($error) { ?><div class="errorWrap"><strong>ข้อผิดพลาด
                                                    ...
                                                    <div class="input-field col m6 s12">
                                                        ...
                                                        <input placeholder="" id="fromdate" name="fromdate"
                                                            class="datepicker" type="date" required>
                                                    </div>
                                                    <div class="input-field col m6 s12">
                                                        <label for="todate">วันสิ้นสุด</label>
                                                        <input placeholder="" id="todate" name="todate"
                                                            class="datepicker" type="date" required>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <label for="picture">อัปโหลดเอกสาร</label>
                                                        <div class="file-field input-field">
                                                            <div class="btn">
                                                                <span>เลือก</span>
                                                                <input type="file" id="leave_picture"
                                                                    name="leave_picture" />
                                                            </div>
